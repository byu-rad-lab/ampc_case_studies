...
class PlotWindow:
    def __init__(self, legend: bool=True, deg: bool=True,
        ...
        self.window = TabbedWindow('Multirotor Simulation Data', fig_size)
        self.tabs = []
    ...
    def _setupStatePlot(self):
        ...
        ax[0].set_ylabel(r'$p_n$ (m)')
        ax[1].set_ylabel(r'$p_e$ (m)')
        ax[2].set_ylabel(r'$p_d$ (m)')
        ...
        ax[2].set_xlabel('time (s)')
        name = 'Attitude'
        self.window.addTab(name, self.att_fig)
        self.tabs.append(name)
    ...
    def _setupInputPlot(self):
        ...
        ax[0].set_ylabel('s')
        ax[1].set_ylabel(r'$\omega_x$')
        ax[2].set_ylabel(r'$\omega_y$')
        ax[3].set_ylabel(r'$\omega_z$')
    ...
    def show(self):
        ...
        if 'Position' in self.tabs:
            ...
            self.window.tabs.setCurrentIndex(self.tabs.index('Attitude'))
        ...
        if 'Inputs' in self.tabs:
            ...
            if self.legend and 5 > len(self.u_ax[0].get_lines()) > 1:
    ...
    def savePlots(self, path: str, end: str='', image_type: str='svg'):
        ...
        if 'Position' in self.tabs:
            ...
            self.att_fig.savefig(f'{path}attitude{end}.{image_type}')
